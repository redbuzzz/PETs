...
class Review(models.Model):
    ...
    customer = models.ForeignKey(Customer, on_delete=models.CASCADE, related_name='customer_reviews', null=True,
                                 blank=True)
    executor = models.ForeignKey(Executor, on_delete=models.CASCADE, related_name='executor_reviews', null=True,
                                 blank=True)
