...
class TaskViewSetTestCase(APITestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            email="testuser@example.com", password="testpasswordT123"
        )
        self.customer = Customer.objects.create(user=self.user)
        self.task1 = Task.objects.create(
            title="Task 1", description="Task 1 Description", customer=self.customer
        )
        self.task2 = Task.objects.create(
            title="Task 2", description="Task 2 Description", customer=self.customer
        )
    ...
    def test_create_task(self):
        ...
        data = {"title": "Task 3", "description": "Task 3 Description", "tags": tag_pks}
...
class BidViewSetTestCase(APITestCase):
    def setUp(self):
        ...
        self.executor_user = User.objects.create_user(
            email="testexecutor@example.com", password="testpasswordT123"
        )
        self.customer = Customer.objects.create(user=self.user)
