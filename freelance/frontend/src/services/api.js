...
export async function createCustomer() {
    const response = await api.post('/create_customer/')
    return response.status
}

export async function createFreelancer() {
    const response = await api.post('/create_freelancer/')
    return response.status
}

export async function chooseCustomer() {
    const response = await api.patch('/switch_role/', {
        is_customer: true
    })
    return response.status
}
export async function chooseFreelancer() {
    const response = await api.patch('/switch_role/', {
        is_customer: false
    })
    return response.status
